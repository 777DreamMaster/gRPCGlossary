...
class GlossaryServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.AddTerm = channel.unary_unary(
                ...
                response_deserializer=glossary__pb2.MessageResponse.FromString,
                _registered_method=True)
...
def add_GlossaryServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'AddTerm': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=glossary__pb2.MessageResponse.SerializeToString,
            ),
...
class GlossaryService(object):
    ...
    def AddTerm(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            glossary__pb2.MessageResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
